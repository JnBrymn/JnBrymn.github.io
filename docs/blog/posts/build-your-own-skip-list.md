...
## So let's build one!
I've always wanted to build my own skip list from scratch and I finally had a chance to take a stab at it today. The code below is not completely general ([I'm building this so that I can use it in a data sketch that I blog about here](distro-sketch-sketch.md)) but it does showcase how the data structure works.
